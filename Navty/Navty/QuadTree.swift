...
class QuadTree <T> {
    ...
    func insertObject(object: T, atPoint point: CGPoint) -> Bool {
        ...
        if northWest != nil && northWest!.insertObject(object: object, atPoint: point) {
            return true
        }
        else if northEast != nil && northEast!.insertObject(object: object, atPoint: point) {
            return true
        }
        else if southWest != nil && southWest!.insertObject(object: object, atPoint: point) {
            return true
        }
        else if southEast != nil && southEast!.insertObject(object: object, atPoint: point) {
            return true
        }
